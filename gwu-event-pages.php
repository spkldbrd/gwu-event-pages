...
require_once GWU_EP_PLUGIN_DIR . 'includes/class-gwu-geocode-log.php';
require_once GWU_EP_PLUGIN_DIR . 'includes/class-gwu-geocode.php';
...
add_action( 'plugins_loaded', function() {
	...
	// Post meta set by Hostlinks Page Sync via the REST API.
