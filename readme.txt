...
= 1.2.26 =
* CSS for structured host/venue lines (`.gwu-host-venue-line--*`) from Marketing Ops 1.11.29+ sync.
...
= 1.2.23 =
* New `[event_course_type]` shortcode for sidebar Course Type (meta from Hostlinks page sync).
...
* Revert v1.3.0 Page Content admin and section shortcodes — boilerplate stays on Marketing Ops Page Template.
